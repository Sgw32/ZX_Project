...
SM_Move2:
            ...
            ld bc, &FEFE           ; check keys from Space-B
            in a, (c)              ; get keys
...
UP2:    defm "  "
        defb 0
HI:     defm "MILITARY BASE"
        defb 0
SCORE1: defm "      "
        defb 0
SCORE2: defm "      "
        defb 0
SCOREH: defm "PLACE THE ARTIFACT"
        defb 0
TRYAGAIN: defm "TRY AGAIN!        "
        defb 0
MAPPOS: defm "08, 10"
        defb 0
; ATTR for the score panel at the top of the screen
SCOREC: defb 69, 69, 69, 69, 69, 69, 71, 71, 71,  7,  7,  7,  7,  7,  7, 87, 87,  87, 87, 87, 87, 87, 87, 87, 87, 87, 87, 87, 87, 87, 87, 87
